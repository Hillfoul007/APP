              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  {booking.status === "completed" && (
                    <Button
                      variant="outline"
                      className="flex-1 rounded-xl border-2 border-yellow-200 hover:bg-yellow-50"
                    >
                  ...
                  {canCancelBooking(booking) && (
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <Button
                          variant="outline"
                          className="flex-1 rounded-xl border-2 border-red-200 hover:bg-red-50 text-red-600"
                        >
                  ...
                  <Button
                    variant="outline"
                    className="flex-1 rounded-xl border-2 border-blue-200 hover:bg-blue-50"
                  >
